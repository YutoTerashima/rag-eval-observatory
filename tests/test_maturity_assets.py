...
def test_project_specific_maturity_modules_import():
    import rag_eval_observatory.retrievers as _retrievers
    import rag_eval_observatory.reranking as _reranking
    import rag_eval_observatory.failure_taxonomy as _failure_taxonomy
